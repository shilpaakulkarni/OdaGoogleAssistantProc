...
module.exports = (app) => {
  ...
  const webhook = new WebhookClient({
    channel: {
      url: 'https://botv2lhr1I0009H8B349Bbots-mpaasocimt.botmxp.ocp.oraclecloud.com:443/connectors/v1/tenants/idcs-6d466372210e4300bb31f4db15e8e96c/listeners/webhook/channels/255e5acf-9651-4a78-bd7e-9e252922fbef',
      secret: 'BnJMzxPC11u1YLLDFEMm9kt9tepfYyzs'
    }
  });
